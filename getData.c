...
char filename[80];
int nx, ny, len;
double xmin, ymin, xmax, ymax, Deltax, Deltay, Ohf, Ohd, Ohs;
...
int main(int a, char const *arguments[])
{
  ...
  ny = atoi(arguments[6]);
  Ohf = atof(arguments[7]); Ohd = atof(arguments[8]);
  Ohs = atof(arguments[9]);
  ...
  */
  ...
  foreach() {
    ...
    D2c[] = 2*(clamp(f1[]*(1-f2[]), 0., 1.) * Ohf + clamp(f1[]*f2[], 0., 1.) * Ohd + clamp((1-f1[]), 0., 1.) * Ohs)*D2;
